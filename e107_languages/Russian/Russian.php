...
define("LAN_DEVELOPERMODE_CHECK", "[b] Режим разработчика включен. Используйте этот режим только при разработке! [/b] [br] Отключите режим разработчика при использовании веб-сайта в реальном времени. Когда включен режим разработчика, конфиденциальная информация может быть показана публично!");
