...
define("LAN_CRON_06_1", "Триггер запрета процесса");
...
define("LAN_CRON_65", "Обновить репозиторий темы git");
define("LAN_CRON_66", "Git-репозиторий не найден");
define("LAN_CRON_67", "В папке темы не найден Git-репозиторий ");
