...
define("LAN_EURL_PROFILE_INFO", "Информация о шаблоне недоступна");
define("LAN_EURL_LOCATION", "Расположение URL шаблона");
define("LAN_EURL_LOCATION_NONE", "Конфигурационный файл недоступен");
...
define("LAN_EURL_LEGACY", "Системный URL-адрес");
...
define("LAN_EURL_NEWS_REWRITEF_LABEL", "Полностью человеко-понятные URL (влияет на производительность, но максимально понятные)");
...
define("LAN_EURL_USER_REWRITE_DESCR", "Человеко-понятные URL, в том числе и для поисковых ботов.");

define("LAN_EURL_CORE_PAGE", "Созданные страницы");

define("LAN_EURL_PAGE_SEF_LABEL", "Человеко-понятные URL с идентификатором (производительность)");
...
define("LAN_EURL_SEARCH_DEFAULT_DESCR", "Системный URL-адрес");
...
define("LAN_EURL_SYSTEM_DEFAULT_LABEL", "Системный URL по умолчанию");
define("LAN_EURL_SYSTEM_DEFAULT_DESCR", "URL-адреса для страниц ошибок, отказов в доступе, и т.д.");

define("LAN_EURL_SYSTEM_REWRITE_LABEL", "ЧПУ Системы");
define("LAN_EURL_SYSTEM_REWRITE_DESCR", "URL-адреса для страниц ошибок, отказов в дпступе, и т.д.");
