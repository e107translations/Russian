...
define("LCLAN_24", "Открывает мини-окно 600 x 400");
define("LCLAN_78", "Показать описание как экран Tip");
...
define("LCLAN_108", "Некоторые параметры опущены - нельзя задать ссылку как Sublink его Sublink.");
define("LCLAN_109", "Пожалуйста, выберите один из родителей");
define("LCLAN_110", "Пожалуйста, выберите модуль генератора");
define("LCLAN_111", "Не является допустимым генератор данных модуля");
define("LINKLAN_1", "Открывается в окне 800 x 600");
define("LINKLAN_4", "Sublink генератор");
define("LINKLAN_5", "Создание Sublinks");
define("LINKLAN_6", "Создание sublinks от");
