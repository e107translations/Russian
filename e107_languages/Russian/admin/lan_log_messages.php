...
define("LAN_AUDIT_LOG_023", "Сброс отрицательного ответа почты юзера");
define("LAN_AUDIT_LOG_024", "Временный статус пользователя");

// Admin log events
//-----------------
define("LAN_AL_ADLOG_01", "Журнал логов Админа - обновление настроек");
define("LAN_AL_ADLOG_02", "Журнал логов Админа - удалены старые данные");
...
define("LAN_AL_USET_13", "Удалены сообщения возвращенных отказов");
...
define("LAN_AL_THEME_03", "Пред-загрузка изображения/обновление CSS сайта");
define("LAN_AL_THEME_04", "Обновление стилей/CSS Администратора");
...
// Notify
//-------
define("LAN_AL_NOTIFY_01", "Обновление параметров уведомлений");
...
define("LAN_AL_USET_100", "Админ вошел от имени пользователя");
define("LAN_AL_USET_101", "Админ вышел из аккаунта пользователя");
