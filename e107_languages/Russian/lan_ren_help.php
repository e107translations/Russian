...
define("LANHELP_37", "Вставка изображения из директории e107_images/newspost_images/");
...
define("LANHELP_44", "Нажмите, чтобы открыть/закрыть диалоговое окно эмотиконов ...");
define("LANHELP_45", "Вставка изображения из менеджера мультимедиа");
