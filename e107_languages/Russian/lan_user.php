...
define("LAN_USER_04", "Персональный заголовок");
define("LAN_USER_06", "Фотография");
define("LAN_USER_07", "Аватар");
define("LAN_USER_09", "Подпись");
define("LAN_USER_10", "Скрыть адрес эл. почты на сайте");
...
define("LAN_USER_66", "Визитов на сайт");
...
define("LAN_USER_75", "Ваше [x] обязательно для заполнения");
define("LAN_USER_76", "Подписан на");
define("LAN_USER_77", "Ваш пароль должен содержать не менее [x] символов");
...
define("LAN_USER_83", "Скрыть адрес эл. почты?");
